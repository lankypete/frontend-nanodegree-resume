...
var bio = {
    ...
    "display": function bioDisplay() {
        ...
        //Display Footer
        var footerMobile = HTMLfooterMobile.replace("%data%", bio.contacts.mobile);
        var footerEmail = HTMLfooterEmail.replace(/%data%/g, bio.contacts.email);
        $("#footerContacts").append(footerMobile + footerEmail);
    }
};
bio.display();
...
var education = {
    ...
    "display": function educationDisplay() {
        ...
        for (var school in education.schools) {
            ...
            var formatLocation = HTMLschoolLocation.
            replace("%data%", education.schools[school].location);
            var formatdegree = HTMLschoolDegree.
            replace("%data%", education.schools[school].degree);
            var formatMajor = HTMLschoolMajor.
            replace("%data%", education.schools[school].majors);
            var formatDates = HTMLschoolDates.
            replace("%data%", education.schools[school].dates);

            $(".education-entry:last").
            append(formatName + formatdegree + formatDates + formatLocation + formatMajor);
        }
